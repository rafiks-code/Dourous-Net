    ...
    <div className="page-container max-w-6xl mx-auto py-10 px-4" dir={isAr ? 'rtl' : 'ltr'}>
      <div className="space-y-12">
        <header className="space-y-2 animate-fade-slide-up">
          ...
          <p className="text-white/50">Consultez les corrections de vos devoirs</p>
        </header>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 animate-fade-slide-up">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">Aucune correction disponible</h2>
            <p className="text-white/40">Les corrections apparaîtront ici quand le professeur les publiera</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="p-8 space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/50 line-clamp-2 leading-relaxed">
                        {correction.filiere || 'Tous les étudiants'}
                      </p>
                    </div>
