...
export default function ProfMessagesPage() {
  ...
  return (
    <div className="page-container max-w-6xl mx-auto h-[calc(100vh-6rem)] py-6">
      <div className="flex flex-col h-full space-y-4">
        ...
        <div className="flex-1 glass-card overflow-hidden flex flex-col md:flex-row">
          {/* Sidebar */}
          <div className="w-full md:w-80 border-b md:border-b-0 md:border-r border-white/10 flex flex-col bg-white/5">
            <div className="p-4 border-b border-white/10">
              <Input placeholder="Chercher un élève..." className="bg-black/20 border-white/5" />
            </div>
          ...
          <div className="flex-1 flex flex-col bg-[#07071a]/50">
            {selectedStudent ? (
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                  {messages.length === 0 ? (
                    <div className="h-full flex flex-col items-center justify-center text-center opacity-50">
                      ...
                      <p>Envoyez un message à {selectedStudent.full_name}</p>
                    </div>
                  ) : (
                    messages.map(msg => {
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center opacity-50 p-6">
                ...
                <h3 className="text-xl font-medium text-white mb-2">Sélectionnez un élève</h3>
                <p className="text-sm">Pour commencer une discussion ou répondre à une question.</p>
              </div>
            )}
          </div>
        </div>
